...
if("TRUE" STREQUAL "TRUE")
  set(moveit_simple_controller_manager_SOURCE_PREFIX /home/ros/Desktop/rosws/src/ROS - Indigo/moveit_simple_controller_manager)
  set(moveit_simple_controller_manager_DEVEL_PREFIX /home/ros/Desktop/rosws/devel)
  ...
  set(moveit_simple_controller_manager_INSTALL_PREFIX /home/ros/Desktop/rosws/install)
...
if(NOT " " STREQUAL " ")
  ...
  set(_include_dirs "")
  if(NOT "https://github.com/ros-planning/moveit_plugins/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/ros-planning/moveit_plugins/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://moveit.ros.org " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Michael Ferguson <fergs@unboundedrobotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_simple_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/Desktop/rosws/src/ROS - Indigo/moveit_simple_controller_manager/${idir}'.  ${_report}")
    endif()
...
set(moveit_simple_controller_manager_EXPORTED_TARGETS "moveit_simple_controller_manager_generate_messages_cpp;moveit_simple_controller_manager_generate_messages_eus;moveit_simple_controller_manager_generate_messages_lisp;moveit_simple_controller_manager_generate_messages_nodejs;moveit_simple_controller_manager_generate_messages_py")
...
set(pkg_cfg_extras "moveit_simple_controller_manager-msg-extras.cmake")
