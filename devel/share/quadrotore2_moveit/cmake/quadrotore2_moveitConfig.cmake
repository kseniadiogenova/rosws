...
if("TRUE" STREQUAL "TRUE")
  set(quadrotore2_moveit_SOURCE_PREFIX /home/ros/Desktop/rosws/src/Autonomous-Flight-ROS-master/ROS - Indigo/quadrotore2_moveit)
  set(quadrotore2_moveit_DEVEL_PREFIX /home/ros/Desktop/rosws/devel)
  ...
  set(quadrotore2_moveit_INSTALL_PREFIX /home/ros/Desktop/rosws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'quadrotore2_moveit' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'quadrotore2_moveit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/Desktop/rosws/src/Autonomous-Flight-ROS-master/ROS - Indigo/quadrotore2_moveit/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${quadrotore2_moveit_dep}_FOUND)
      find_package(${quadrotore2_moveit_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${quadrotore2_moveit_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
