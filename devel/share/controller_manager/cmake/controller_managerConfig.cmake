...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/ros/Desktop/rosws/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/ros/Desktop/rosws/devel)
  ...
  set(controller_manager_INSTALL_PREFIX /home/ros/Desktop/rosws/install)
...
if(NOT "/home/ros/Desktop/rosws/src/ros_control/controller_manager/include;/usr/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/ros/Desktop/rosws/src/ros_control/controller_manager/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/Desktop/rosws/src/ros_control/controller_manager/${idir}'.  ${_report}")
    endif()
    _list_append_unique(controller_manager_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "controller_manager;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
...
set(depends "controller_interface;controller_manager_msgs;hardware_interface;pluginlib")
